...
/* Iterator - an object that facilitates the traversal of a data structure
      1. an iterator specifies how you can traverse an object
      2. Iterator cannot be recursive (no coroutines)
      3. Iterator implements Iterator<T>, iterable object implements Iterable<T>
 * */
class Node<T> {
  public T value;
